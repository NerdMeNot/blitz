...
sidebar:
  order: 1
slug: 1.0.0-zig0.15.2/api/core-api
---
...
All tasks complete before errors propagate. See [Error Handling](/1.0.0-zig0.15.2/usage/error-handling/) for details.
...
For dynamic task spawning. See [Scope & Broadcast](/1.0.0-zig0.15.2/usage/scope-broadcast/) for details.
