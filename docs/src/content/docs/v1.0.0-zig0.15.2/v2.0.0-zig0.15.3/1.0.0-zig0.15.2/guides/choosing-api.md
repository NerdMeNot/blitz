...
slug: v1.0.0-zig0.15.2/v2.0.0-zig0.15.3/1.0.0-zig0.15.2/guides/choosing-api
---
...
Use `try*` variants when your parallel body can return a Zig error. See [Error Handling](/v1.0.0-zig0.15.2/v2.0.0-zig0.15.3/1.0.0-zig0.15.2/usage/error-handling/) for details.
