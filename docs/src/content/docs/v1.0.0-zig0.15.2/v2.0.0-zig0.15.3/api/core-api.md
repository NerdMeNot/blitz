...
sidebar:
  order: 1
slug: v1.0.0-zig0.15.2/v2.0.0-zig0.15.3/api/core-api
---
...
All tasks complete before errors propagate. See [Error Handling](/v1.0.0-zig0.15.2/v2.0.0-zig0.15.3/usage/error-handling/) for details.
...
For dynamic task spawning. See [Scope & Broadcast](/v1.0.0-zig0.15.2/v2.0.0-zig0.15.3/usage/scope-broadcast/) for details.
