...
slug: v1.0.0-zig0.15.2/v2.0.0-zig0.15.3/algorithms/work-stealing
---
...
See [Sleep/Wake Protocol](/v1.0.0-zig0.15.2/v2.0.0-zig0.15.3/internals/sleep-wake-protocol/) for details on the JEC protocol.
