...
slug: v2.0.0-zig0.15.3/1.0.0-zig0.15.2/usage/parallel-for
---
...
See the [Image Processing cookbook recipe](/v2.0.0-zig0.15.3/1.0.0-zig0.15.2/cookbook/image-processing/) for a complete pipeline.
