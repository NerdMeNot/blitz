...
slug: v2.0.0-zig0.15.3/1.0.0-zig0.15.2/guides/migration
---
...
4. **Choose the right API** (see [Choosing the Right API](/v2.0.0-zig0.15.3/1.0.0-zig0.15.2/guides/choosing-api/))
