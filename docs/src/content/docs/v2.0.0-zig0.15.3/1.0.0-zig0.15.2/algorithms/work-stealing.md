...
slug: v2.0.0-zig0.15.3/1.0.0-zig0.15.2/algorithms/work-stealing
---
...
See [Sleep/Wake Protocol](/v2.0.0-zig0.15.3/1.0.0-zig0.15.2/internals/sleep-wake-protocol/) for details on the JEC protocol.
