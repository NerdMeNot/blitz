...
export default defineConfig({
	...
	integrations: [
		starlight({
			...
			// Versioning: uncomment when a new version differs from the vv1.0.0-zig0.15.2 snapshot.
			// plugins: [
			// 	starlightVersions({
			// 		versions: [{ slug: 'v1.0.0-zig0.15.2', label: 'v1.0.0-zig0.15.2' }],
			// 	}),
			// ],
			components: {
